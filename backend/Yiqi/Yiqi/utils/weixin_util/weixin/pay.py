...
from utils.weixin_util.weixin.helper import smart_str, smart_unicode, md5_constructor as md5
...
class WeixinPay(object):
    ...
    def make_request(self, method, url, kwargs):
        '''
        这里kwargs需要转换utf-8不然不能进行编码发送
        :param method:
        :param url:
        :param kwargs:
        :return:
        '''
        req = requests.request(method, url, timeout=TIMEOUT, data=str(kwargs['data']).encode('utf-8'),)
        # xml to dict
